                    ...
                    <div class="uk-width-1-1">
                            <div class="uk-flex" uk-grid>
                                ...
                                <div class="uk-width-1-3@l uk-padding-large" style="z-index: 999; background-color: rgba(35, 35, 78, 0.541);">
                                            <a class="menu-button uk-button uk-button-primary" href="<?php echo base_url()?>">Información cuidado físico</a><br>
                                            <a class="menu-button uk-button uk-button-primary" href="<?php echo base_url()?>">Información cuidado mental</a><br>
                                            <a class="menu-button uk-button uk-button-primary" href="<?php echo base_url()?>">Información cuidado alimenticio</a><br>
                                </div>
                            </div>
                    </div>
                </div>
