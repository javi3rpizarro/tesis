        ...
        <div class="fondo">
                <div class="contenedor_menu">
                    ...
                    <div class="contenedor_botones">
                          <div> <button onclick="location.href='http://localhost/index.php/juego/juego1'">Juego motricidad fina</button></div> <br>
                        <div> <button>Juego ejercicio mental</button></div><br>
                        <div> <button>Juego salud alimenticia</button></div><br>
                    </div>      
