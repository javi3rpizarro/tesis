        ...
        <div class="fondo">
                <div class="contenedor_menu">
                    ...
                    <div class="contenedor_botones">
                          <div> <button onclick="location.href='http://localhost/index.php/video/video1'">Video cuidado físico</button></div> <br>
                        <div> <button>Video cuidado mental</button></div><br>
                        <div> <button>Video cuidado alimenticio</button></div><br>
                    </div>      
