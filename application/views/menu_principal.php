        ...
        <div class="fondo">
                <div class="contenedor_menu">
                    ...
                    <div class="contenedor_botones">
                        <div> <button onclick="location.href='http://localhost/index.php/juego'">Jugar Actividad</button></div> <br>
                        <div> <button onclick="location.href='http://localhost/index.php/video'">Videos Informativos</button></div><br>
                        <div> <button onclick="location.href='http://localhost/index.php/informacion'">Información Útil</button></div><br>
                    </div>      
